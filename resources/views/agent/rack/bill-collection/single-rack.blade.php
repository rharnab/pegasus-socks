                                                    ...
                                                    <div class="demo">
                                                         @foreach($rack_shocks_size['shocks'] as $size_single_shocks)
                                                            <div class="custom-control custom-checkbox single_checkbox">
                                                                <input type="checkbox" onclick="countTotalSoldoutSocks('{{ $size_single_shocks['shocks_code'] }}')" class="select_items custom-control-input rack_single_shocks_{{  $size_single_shocks['month'] }}" value="{{ $size_single_shocks['shocks_code'] }}" id="{{ $size_single_shocks['shocks_code'] }}">
...
<script>
    function shocksBillCollection(){
        ...
        var base_url = window.location.origin + '/pegasus-socks/';
                        ...
                        success: (data) => {
                            ...
                            if(data.status === 200){
                                cuteAlert({
                                    ...
                                    // window.open(base_url+"voucher/shop/rack-bill-info/"+data.bill_no, '_blank');
