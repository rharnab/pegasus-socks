                                                ...
                                                <tbody>  
                                                    @foreach ($vouchers as $svoucher)
                                                        <tr>
                                                            ...
                                                            <td>{{ number_format($svoucher->venture_amount,2) }}</td>
                                                            <td>{{ number_format($svoucher->collect_amount,2) }}</td>    
                                                            <td>{{  date('Y-m-d h:i', strtotime($svoucher->entry_datetime)) }}</td>
                                                             <td> 
                                                                <!-- <a href="{{ asset('public/'.$svoucher->voucher_link) }}"> Download </a> -->
                                                                <a href="{{ asset("voucher/shop/rack-bill-voucher/$svoucher->shocks_bill_no") }}">Download</a>
