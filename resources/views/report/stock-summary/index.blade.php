                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('report.stock.summary-details') }}" method="post" enctype="multipart/form-data" target="_blank">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-control select2" name="lot_no" required>
                                            <option value="0">--All--</option>
                                               @foreach($lots_no as $single_lot)

                                               <option value="{{$single_lot->lot_no}}">{{ $single_lot->lot_no }}</option>
