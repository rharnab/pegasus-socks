...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">Lot Brands</li>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('report.lot_brands_report_table') }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <select class="form-control select2" name="lot_no" required>
                                            <option value="">--select--</option>
                                               @foreach($lots as $single_lot_info)

                                               <option value="{{$single_lot_info->lot_no}}">{{$single_lot_info->lot_no}}</option>
