                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('parameter_setup.brand.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        ...
                                        <input type="text" name="brand_short_code" id="brand_short_code" value="{{$get_data->short_code}}" class="form-control" required>
