...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> Product Categoris List </li>
...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.product_categories.create')}}" class="btn btn-sm btn-primary">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$sl++}}</td>    
                                                        <td>{{$single_info->starting_amt}}</td>    
                                                          
                                                        <td>{{$single_info->ending_amt}}</td>    
                                                        <td>{{$single_info->short_code}}</td>    
                                                        <td>{{$single_info->full_name}}</td>    
