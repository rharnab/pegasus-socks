...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active">Product Categories Create Form</li>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="" action="{{ route('parameter_setup.product_categories.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="name"> Starting Amount </label>
                                        
                                        <input type="text" name="starting_amt" class="form-control" required>
                                ...
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label class="form-label" for="name">Ending Amount</label>
                                        
                                       <input type="text" name="ending_amt" class="form-control" required>
                                ...
                                <div class="form-row">
                                 ...
                                 <div class="form-row">
                                      ...
                                      <div class="col-md-12 mb-3">
                                        <label class="form-label" for="code">Full Name</label>
