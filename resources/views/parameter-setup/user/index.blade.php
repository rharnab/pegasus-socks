...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.user.create')}}" class="btn btn-sm btn-primary">
                    <span class="fal fa-plus mr-1"></span> Add New User
                </a>
            </span>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(!empty($single_info->image))
                                                                <img src="{{ asset('uploads/user_image')}}/{{$single_info->image}}" style="border-radius: 50%" width="50" height="50">
                                                            @else 
                                                                <img src="{{ asset('public/backend/assets/img/avatar.png') }}" style="border-radius: 50%" width="50" height="50">
                                                            @endif
                                                        </td>
                                                        <td>@if($single_info->role_id=='1')
                                                                 Admin
                                                            @elseif($single_info->role_id=='2')

                                                                  Agent User

                                                             @elseif($single_info->role_id=='3')

                                                                  Stock Manager
                                                            
                                                            @elseif($single_info->role_id=='4')

                                                                  Account Manger

                                                             @elseif($single_info->role_id=='5')
                                                        ...
                                                        <td><a href="{{url('parameter-setup/user/edit')}}/{{$single_info->id}}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a></td>    
                                                    </tr>
