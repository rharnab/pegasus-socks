...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> Brand Size List </li>
...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.brandsize.create')}}" class="btn btn-sm btn-primary">
                                        ...
                                        <div class="panel-content">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>{{$sl++}}</td>    
                                                        <td>{{$single_info->brand_sise_name}}</td>    
