                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="agent_create_form"  action="{{ route('parameter_setup.agent.update') }}" method="post" enctype="multipart/form-data">
                                 ...
                                 <div class="form-row">
                                      ...
                                      <div class="col-md-12 mb-3">
                                        <label class="form-label" for="code">Present Address</label>
                                            <input type="text" name="present_address" id="present_address" class="form-control" value="{{$get_data->present_address}}" required>
                                ...
                                <div class="form-row">
                                      ...
                                      <div class="col-md-12 mb-3">
                                        <label class="form-label" for="code">Permanent Address</label>
                                            <input type="text" name="permanent_address" id="permanent_address" class="form-control"  value="{{$get_data->permanent_address}}"  required>
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                         ...
                                         @if(!empty($get_data->image))
                                            <img src="{{ asset('uploads/agent_user_image')}}/{{$get_data->image}}"  width="50" height="50">
                                        @else 
                                 ...
                                 <div class="form-row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                         ...
                                         @if(!empty($get_data->nid_image))
                                            <img src="{{ asset('uploads/agent_user_nid')}}/{{$get_data->nid_image}}"  width="50" height="50">
                                        @else 
                                            <img src="{{ asset('public/backend/assets/img/avatar.png') }}"  width="50" height="50">
                                        @endif
