...
<!-- BEGIN Page Content -->
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item active"> Racks List </li>
...
<div class="subheader">
        <h1 class="subheader-title">            
            ...
            <span style="float:right">
                <a href="{{route('parameter_setup.racks.create')}}" class="btn btn-sm btn-primary">
                                            ...
                                            <table id="dt-basic-example" class="table table-bordered table-hover table-striped table-sm w-100">
                                                <thead class="bg-primary-600" style="text-transform: uppercase">
                                                    <tr>
                                                        ...
                                                        <th>Rack Level </th>
                                                        <th>per Level Socks</th>
                                                        <th>Maximum Shocks Capacity</th>
                                                        <th>Status</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$single_info->rack_category}}</td>    
                                                        <td>{{$single_info->rack_level}}</td>    
                                                        <td>{{$single_info->per_level_socks}}</td>    
                                                        <td>{{$single_info->total_count}}</td> 
                                                    ...
                                                    <?php  
                                                      ...
                                                      $status =  $single_info->status;
                                                                                                           
                                                      if($status=='1'){
                                                        echo "<span class='badge badge-success'>Shop</span>";
                                                      }else{
