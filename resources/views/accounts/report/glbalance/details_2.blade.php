                            ...
                            <div class="col-md-6">
                                ...
                                <div id="treeview1" class="treeview">
                                    <ul class="list-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                        ...
                                                        {{ getBalance($single_level_one_result->acc_no) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                        ...
                                                        {{ getBalance($single_level_two_result->acc_no) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                      ...
                                                      {{ getBalance($single_level_three_result->acc_no) }}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                       ...
                                                       {{ getBalance($single_level_four_result->acc_no) }}
                                        ...
                                        $chiled_level_five= DB::table('gl_accounts')->where([
                                                                ['gl_level', '=', 5],
                                                                ['asset_liability_status', '=', 0],
                                                                ['mother_ac_no', '=' , $single_level_four_result->acc_no] 
                                        ...
                                        <li style="padding-left: 10rem" class="list-group-item node-treeview1 " data-nodeid="1">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <span class="indent"></span><span
                                                        class="icon expand-icon glyphicon glyphicon-plus"></span><span
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                       ...
                                                       {{ getBalance($single_level_five_result->acc_no) }}
                                        ...
                                        $chiled_level_six= DB::table('gl_accounts')->where([
                                                                ['gl_level', '=', 6],
                                                                ['asset_liability_status', '=', 0],
                                                                ['mother_ac_no', '=' , $single_level_five_result->acc_no] 
                                        ...
                                        <li style="padding-left: 12rem" class="list-group-item node-treeview1 " data-nodeid="1">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <span class="indent"></span><span
                                                        class="icon expand-icon glyphicon glyphicon-plus"></span><span
                                                ...
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                       ...
                                                       {{ getBalance($single_level_six_result->acc_no) }}
                                        ...
                                        $chiled_level_seven= DB::table('gl_accounts')->where([
                                                                ['gl_level', '=', 7],
                                                                ['asset_liability_status', '=', 0],
                                                                ['mother_ac_no', '=' , $single_level_six_result->acc_no] 
                                        ...
                                        @endphp
                                        @foreach($level_seven_result as $single_level_seven_result)

                                        <li style="padding-left: 14rem" class="list-group-item node-treeview1 " data-nodeid="1">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <span class="indent"></span><span
                                                        class="icon expand-icon glyphicon glyphicon-plus"></span><span
                                                        ...
                                                        {{ $single_level_seven_result->acc_name }}
                                                </div>
                                                <div class="col-md-6 text-right">
                                                    <span class="indent"></span><span
                                                        class="icon expand-icon glyphicon glyphicon-plus"></span><span
                                                       ...
                                                       {{ getBalance($single_level_seven_result->acc_no) }}
