    ...
    public function rackDetails($rack_id){
        ...
        foreach($rack_style_sizes as $rack_style_size){
            $rack_shocks_array[$rack_style_size->sold_date] = [
                "type_id" => (Int) date('m', strtotime($rack_style_size->sold_date)),
                "name"    => $rack_style_size->sold_date,
        ...
        // echo "<pre>";
        // print_r($rack_shocks_array);

        // foreach($rack_shocks_array[$sold_date]['shocks'] as $rack_shocks_size) //$rack_shocks_array[$rack_shocks_size['sold']]['shocks']
        // {   
        //       echo "<pre>";
        //        print_r($rack_shocks_size);
        // }      
